...
-Step 8. If the user **DOES NOT fall under** EIP, **DO NOT** conduct a Social Care Assessment. Ask **generic questions** to better understand the user's problem. Once done, signpost the user to relevant information.
